    ...
    init() {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            tips.addEventListener("click", function () {
                chrome.tabs.create({
                    url: tips.getAttribute("data-href"),
                    active: true
                });
            });
            ...
            chrome.windows.getCurrent({
                ...
                window.tabs.forEach(element => {
                    ...
                    let ct_tab = document.createElement('li');

                    let ct_tab_close = document.createElement('span');
                    ct_tab_close.className = "ct-tab-close";


                    ct_tab_close.data_closetabid = element.id;

                    let ct_tab_label = document.createElement('span');
                    ct_tab_label.className = "ct-tab-label";



                    let attribs = Object.keys(element);
                ...
                container.style.borderBottom = "5px solid " + selectedClr;
